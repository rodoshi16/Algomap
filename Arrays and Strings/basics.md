...
at 0 and the last position is n-1. In a static array, you can still

- index an element
- add/remove

However, the size is determined based on the numbers provided during initialization which is fixed once defined. The memory is
